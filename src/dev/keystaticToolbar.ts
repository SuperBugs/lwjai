 ...
 *   - 「封面图」  → /_xhs     【2026-09-22】每条内容一张 1080×1440 的小红书封面图
 ...
 * ★【2026-09-22】「封面图」（/_xhs）排在「发帖文案」前面：发小红书时先要图，
 *   文案是配着图写的；两条挨着放是因为它们是同一件事（发出去）的两半。
...
export const NAV_LINKS: readonly {
  ...
  },
  {
    ...
    text: "封面图",
    title:
      "每条已发布的内容一张 1080×1440（3:4）的小红书封面图，点一下下载" +
      "（新标签页打开 /_xhs）。和「发帖文案」是一对：那边出字，这边出图。",
  },
  {
    id: SHARE_ID,
    href: SHARE_ROUTE,
